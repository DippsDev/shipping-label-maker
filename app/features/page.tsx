            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {/* Pay-per-label */}
                        <div className="bg-white p-8 rounded-lg border-2 border-gray-200 hover:border-gray-400 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 transform">
                        ...
                        {/* Subscription */}
                        <div className="bg-white p-8 rounded-lg border-2 border-gray-900 hover:border-gray-700 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 transform relative">
