...
import { Package, LayoutDashboard, Tag, History, Wallet, MapPin, Search, Settings, Menu, X, LogOut } from "lucide-react";
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <main className="flex-1 w-full xl:w-auto">
                ...
                <header className="bg-white border-b border-gray-200 px-4 md:px-8 pb-4 safe-top flex items-center justify-between">
                    <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1 xl:flex-initial">
                            <h1 className="text-lg md:text-2xl font-semibold text-gray-900">Welcome to Label Maker</h1>
                            <p className="hidden sm:block text-xs md:text-sm text-gray-600 mt-1">Professional shipping label and barcode generation</p>
                        </div>
                    </div>
                ...
                <div className="p-4 md:p-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                        <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200">
                            <div className="flex items-center justify-between mb-3 md:mb-4">
                                <h3 className="text-sm md:text-lg font-semibold text-gray-900">Total Labels</h3>
                                <Tag className="h-6 w-6 md:h-8 md:w-8 text-gray-600" />
                            </div>
                            <p className="text-2xl md:text-3xl font-bold text-gray-900">{stats.totalLabels}</p>
                            <p className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2">Generated this month</p>
                        </div>

                        <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200">
                            <div className="flex items-center justify-between mb-3 md:mb-4">
                                <h3 className="text-sm md:text-lg font-semibold text-gray-900">Most Used</h3>
                                <Package className="h-6 w-6 md:h-8 md:w-8 text-gray-600" />
                            </div>
                            <p className="text-2xl md:text-3xl font-bold text-gray-900">{stats.mostUsedCarrier}</p>
                            <p className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2">Carrier preference</p>
                        </div>

                        <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200">
                            <div className="flex items-center justify-between mb-3 md:mb-4">
                                <h3 className="text-sm md:text-lg font-semibold text-gray-900">Saved Addresses</h3>
                                <MapPin className="h-6 w-6 md:h-8 md:w-8 text-gray-600" />
                            </div>
                            <p className="text-2xl md:text-3xl font-bold text-gray-900">{stats.savedAddresses}</p>
                            <p className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2">Quick access</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 md:mt-8 bg-gradient-to-r from-gray-800 to-gray-700 rounded-lg p-5 md:p-8 text-white">
                        <h2 className="text-xl md:text-2xl font-bold mb-2">Need Help Getting Started?</h2>
