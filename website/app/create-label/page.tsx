...
import { Package, LayoutDashboard, Tag, History, Wallet, MapPin, Search, Settings, Download, Printer, BookOpen, Menu, X, Lock, LogOut } from "lucide-react";
                ...
                <header className="bg-white border-b border-gray-200 px-4 md:px-8 pb-4 safe-top flex items-center justify-between">
                    <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1 text-center xl:text-left pr-16 xl:pr-0">
                            <h1 className="text-lg md:text-2xl font-semibold text-gray-900">Create Label</h1>
                            <p className="hidden sm:block text-xs md:text-sm text-gray-600 mt-1">Generate a shipping label for your package</p>
                        </div>
                    </div>
